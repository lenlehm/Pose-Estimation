...
result_1 = image2world(r,face, images{1}, rotationMatrix_1,translationVector_1 , cameraParams, 0.001)  ;   
result_2 = image2world(r,face, images{2}, rotationMatrix_2,translationVector_2 , cameraParams, 0.001)  ;
result_3 = image2world(r,face, images{3}, rotationMatrix_3,translationVector_3 , cameraParams, 0.001)  ;
result_4 = image2world(r,face, images{4}, rotationMatrix_4,translationVector_4 , cameraParams, 0.001)  ;
result_5 = image2world(r,face, images{5}, rotationMatrix_5,translationVector_5 , cameraParams, 0.001)  ;
result_6 = image2world(r,face, images{6}, rotationMatrix_6,translationVector_6 , cameraParams, 0.001)  ;
result_7 = image2world(r,face, images{7}, rotationMatrix_7,translationVector_7 , cameraParams, 0.001)  ;
result_8 = image2world(r,face, images{8}, rotationMatrix_8,translationVector_8 , cameraParams, 0.001)  ;
result = [result_1;
          result_2;
          result_3;
          result_4;
