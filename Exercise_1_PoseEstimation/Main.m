...
result_1, d1 = image2world(r,face, images{1}, rotationMatrix_1,translationVector_1 , cameraParams)  ;   
result_2, d2 = image2world(r,face, images{2}, rotationMatrix_2,translationVector_2 , cameraParams)  ;
result_3, d3 = image2world(r,face, images{3}, rotationMatrix_3,translationVector_3 , cameraParams)  ;
result_4, d4 = image2world(r,face, images{4}, rotationMatrix_4,translationVector_4 , cameraParams)  ;
result_5, d5 = image2world(r,face, images{5}, rotationMatrix_5,translationVector_5 , cameraParams)  ;
result_6, d6 = image2world(r,face, images{6}, rotationMatrix_6,translationVector_6 , cameraParams)  ;
result_7, d7 = image2world(r,face, images{7}, rotationMatrix_7,translationVector_7 , cameraParams)  ;
result_8, d8 = image2world(r,face, images{8}, rotationMatrix_8,translationVector_8 , cameraParams)  ;
result = [result_1;
          result_2;
          result_3;
          result_4;
...
%saving all the necessary infos [3D location, SIFT keypoints]
%    result = [world_point_1, Sift_1;
%        world_point_2, Sift_2;
%        world_point_3, Sift_3;
%        world_point_4, Sift_4;
%        world_point_5, Sift_5;
%        world_point_6, Sift_6;
%        world_point_7, Sift_7;
%        world_point_8, Sift_8;]
