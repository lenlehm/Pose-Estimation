...
image = imread("C:\Users\Lenny\Documents\MATLAB\Exercise 2_RANSAC\exercise02\data\images\detection\DSC_9751.jpg");
I = rgb2gray(image);
...
[tform, inlierDistorted, inlierOriginal] = estimateGeometricTransform(...
    ref_matched_pts, I_matched_pts, 'similarity');
figure;
showMatchedFeatures(ref_img, image, inlierOriginal, inlierDistorted);
...
figure, imshowpair(ref_img,recovered,'montage')
